...
if (!UserUtil::hasPermission($_SESSION['username'], 'admin.user.permission.view')) {
    echo 'no_permission';
    exit();
}
...
<div class="admin-header">
    <div class="admin-header-title mr-auto"> Permission Manager By User <?=$_POST['username']?> </div>
...
<div class="admin-body"> 
    <div class="admin-table">
        <div class="admin-table-header">
            <?php include(LOCAL_PATH_ROOT.'/game/admin/user_permission/table_header.php');?>
        </div>

        <div class="admin-table-scroll">
            <?php include(LOCAL_PATH_ROOT.'/game/admin/user_permission/table_scroll.php');?>
        </div>
    </div>
</div>

<script>
    function reloadUserPermissionAdmin() {
        $.ajax({
    ...
    var userPermissionName = "<?=$_POST['username']?>";
    ...
    $('.sort-column').click(function(e) {
		...
		$.ajax({
            ...
            method: "POST",
            data: {
                "username": userPermissionName,
                "sortBy": userColumnSortBy,
                "sortDir": userColumnSortDir,
            },
            success: function(result){
    ...
    $("#admin-header-add").click(function(e) {
        $.ajax({
            url: "user_permission/add_user_permission_form.php",
            method: "POST",
            data: {
                "username": userPermissionName
            },
    ...
    $("#admin-header-edit").click(function(e) {
        ...
        $.ajax({
            url: "user_permission/edit_user_permission_form.php",
            method: "POST",
            data: {"id": name},
            success: function(result){
                if (result == 'no_permission') {
    ...
    $("#admin-header-remove").click(function (e) {
        ...
        $.ajax({
            url: "user_permission/remove_user_permission.php", 
            method: "POST",
            ...
            success: function(result){
                if (result == 'no_permission') {
                    ...
                    callNotice("Remove User Permission Successfully!");
                    reloadUserPermissionAdmin();
                }
            }
        });
    });
