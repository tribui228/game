...
<div id="modal-header"> Create New Sale</div>
...
<div id="modal-body"> 
    ...
    <form id="add-sale-form" onsubmit="return false;">
        <div class="container p-0">
            <div class="row">
                ...
                <div class="col-12 col-md-6 form-group">
                    ...
                    <input type="text" class="form-control" id="sale-display">
                ...
                <div class="col-12 col-md-6 form-group">
                    ...
                    <input type="number" class="form-control" id="sale-discount">
                ...
                <div class="col-12 col-md-6 form-group">
                    ...
                    <input type="datetime-local" class="form-control" id="sale-begin-date">
                ...
                <div class="col-12 col-md-6 form-group">
                    ...
                    <input type="datetime-local" class="form-control" id="sale-end-date">
...
<div id="modal-footer"> 
    <div class="col-12 form-group mb-0 pr-0 pl-0">
        <button type="submit" class="form-control admin-submit" id="sale-confirm" form="add-sale-form">
            Create Sale
        </button>
    </div>
</div>
        ...
        if (check) {
            ...
            $.ajax({
                ...
                success: function(response){
                    if (response == 0) {
                        callNotice("Create New Sale Successfully!");
