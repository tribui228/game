...
<div id="modal-header"> Create New Genre</div>
        ...
        <div class="container p-0">
            <div class="row">
                ...
                <div class="col-12 col-md-6 form-group">
                    ...
                    <input type="text" class="form-control" id="genre-display">
...
<div id="modal-footer"> 
    <div class="col-12 form-group mb-0 pr-0 pl-0">
        <button type="submit" class="form-control admin-submit" id="genre-confirm" form="add-genre-form">
            Create Genre
        </button>
    </div>
</div>
...
<script>
    $("#genre-confirm").click(function() {
        if (updateName() && updateDisplay()) {
            ...
            $.ajax({
                url: "genre/add_genre.php", 
                method: "POST",
                data: {"name": name, "display": display},
                success: function(response){
                    if (response == 0) {
                        callNotice("Create New Genre Successfully!");
