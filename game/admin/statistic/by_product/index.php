...
// if (!UserUtil::hasPermission($_SESSION['username'], 'admin.statistic.product.view')) {
//     echo 'no_permission';
//     exit();
// }
?>
...
<div class="admin-header">
    <div class="admin-header-title mr-auto"> Statistic By Product </div>
...
<div class="admin-body"> 
    <div class="admin-table">
        <div class="admin-table-header">
            <?php include(LOCAL_PATH_ROOT.'/game/admin/statistic/by_product/table_header.php');?>
        </div>

        <div class="admin-table-scroll">
            <?php include(LOCAL_PATH_ROOT.'/game/admin/statistic/by_product/table_scroll.php');?>
        </div>
    </div>
</div>
...
<script>
    ...
    $('.sort-column').click(function(e) {
		...
		$.ajax({
            url: "statistic/by_product/table_scroll.php",
            method: "POST",
            data: postData,
            success: function(result){
    ...
    $("#admin-header-search").click(function(e) {
        $.ajax({
            url: "statistic/by_product/search_product_form.php",
            method: "POST",
            data: postData,
            success: function(result){
    ...
    $("#admin-header-info").click(function(e) {
        $.ajax({
            url: "statistic/by_product/summary_form.php",
            method: "POST",
            data: postData,
            success: function(result) {
                if (result == 'no_permission') {
