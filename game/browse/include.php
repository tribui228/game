...
include_once($ROOT_DIRECTORY.'/browse/sort-params.php');
include_once($ROOT_DIRECTORY.'/browse/filter-params.php');
include_once($ROOT_DIRECTORY.'/browse/search-params.php');
include_once($ROOT_DIRECTORY.'/browse/product-params.php');
include_once($ROOT_DIRECTORY.'/browse/page-params.php');
?>