<div class="news">
    ...
    <div class="row" style="min-height: 300px">
        <?php
            $products = ProductUtil::getProductsByOrder('release_date', 'DESC');
            if (count($products) == 0) {
                return;
            }
            ...
            for ($i = 0; $i < 6; $i++) :?>
                ...
                <div class="disable-select product-item col-6 col-md-4 col-lg-2 mb-4">
                    <div class="card card-product h-100" role="button">
                        ...
                        <a class="h-100 d-flex flex-column" href="/game/product?name=<?=$name?>">
                            <img id="product-news-image-<?=$i?>" src="<?=$emptyImage?>" alt="" class="card-img">
                            <div>
                ...
                <script>
                    function loadNewsImageProduct() {
                        let _img_<?=$i?> = document.getElementById('product-news-image-<?=$i?>');
