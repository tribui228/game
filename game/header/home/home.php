<li class="nav-item">
    <a class="nav-link d-flex" href="/game/"> 
        <svg class="pr-1" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="home" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" width="25px" height="25px">
